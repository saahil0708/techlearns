...
export default function About() {
  return (
    <section id="about" className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8 bg-[#090d16] flex justify-center items-center relative overflow-hidden">
      <div className="max-w-[75rem] mx-auto text-center font-black uppercase text-[32px] md:text-[44px] leading-[0.9] md:leading-[1.25] tracking-tight text-white z-10">
        ...
        <span className="text-transparent drop-shadow-md" style={{ WebkitTextStroke: '1.5px white' }}>
        ...
        <span className="text-gray-400 font-sans font-black text-lg sm:text-xl md:text-2xl align-middle tracking-normal ml-2 mt-4 inline-block">
