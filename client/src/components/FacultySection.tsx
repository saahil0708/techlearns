        ...
        <div className="grid grid-cols-1 lg:grid-cols-[4.5fr_7.5fr] gap-16 lg:gap-18 items-center">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-gray-200 tracking-wider text-[18px] uppercase font-bold">Meet The Expert</span>
            </div>
            ...
            <div className="flex flex-wrap gap-12 sm:gap-16">
              ...
              <div className="flex flex-col relative z-10">
                ...
                <span className="text-[13px] uppercase text-gray-200 tracking-wider mt-3 font-bold">Successful Project</span>
              </div>
              ...
              <div className="flex flex-col relative z-10">
                ...
                <span className="text-[13px] uppercase text-gray-200 tracking-wider mt-3 font-bold">Brand Grow Globally</span>
              </div>
            </div>
          </div>

          {/* Right Column: Pure CSS Interactive Image Accordion */}
          <div className="h-[500px] lg:h-[600px] flex gap-4 sm:gap-6 group w-full">
            {FACULTY.map((member, idx) => {
              ...
              return (
                <div 
                  key={member.id}
                  className={`group/item relative overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] cursor-pointer min-w-0 ${flexClasses}`}
                >
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent flex flex-col justify-end p-6 z-20 pointer-events-none transition-all duration-700 delay-100 ${textClasses}`}>
                    <h3 className="text-white text-2xl lg:text-[28px] uppercase tracking-tight mb-1 drop-shadow-md line-clamp-1 font-black">
                      {member.name}
                    </h3>
